                    ...
                    <div class="panel-body">
                        <form action="insert.php" class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="sup_name" class="form-control"  placeholder="ชื่อ">
                                </div>
                            </div>
                            <div class="form-group">
                                <h5 class="col-sm-2 control-label">ที่อยู่</h5>
                                <div class="col-sm-8">
                                    <input type="text" name="sup_add" class="form-control"  placeholder="ที่อยู่">
                                </div>
                            </div>
                            <div class="form-group">
                            <h5 class="col-sm-2 control-label">เบอร์โทร</h5>
                                <div class="col-sm-8">
                                    <input type="text" name="sup_tel" class="form-control"  placeholder="เบอร์โทร">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <button type="submit" class="btn btn-danger " formaction="supplier.php">ยกเลิก</button>
                                </div>
