    ...
    <div class="row">
        ...
        <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">พาร์ทเนอร์</li>
            ...
            <div class="content-box-large">
                ...
                <div class="panel-body">
                      ...
                      <thead>
                              <tr>
                                <th >ชื่อ</th>
                                <th width="18%">อีเมลล์</th>
                                <th >เบอร์โทรศัพท์</th>
                                <th width="30%">ที่อยุ่</th>
                            ...
                            while($row = $result->fetch_assoc()) {
                               echo "<tr>";
                                //echo "<td>" . $row["em_id"]. "</td>";
                                    ...
                                    echo "<td>" . $row["partner_mail"]. "</td>";
                                    echo "<td>" . $row["partner_tel"]. "</td>";
                                    echo "<td>" . $row["partner_address"]. "</td>";
                                 
                                    echo "<td>
                                    <a href='update_form.php?txtID=$row[partner_id]'><button class='buttons buttons2'><i class='glyphicon glyphicon-pencil'></i> </button>
                                    <a href='delete.php?txtID=" . $row['partner_id']. "' onclick=\"return confirm('ต้องการจะลบข้อมูลนี้ใช่หรือไม่?')\"><button class='buttons buttons3'><i class='glyphicon glyphicon-trash'></i> </button>
                                   </td>";
                                   echo "</tr>";
                            }
                        }
