                    ...
                    <div class="panel-body">
                        <form action="insert.php" class="form-horizontal" role="form">
                            ...
                            <h5 class="col-sm-2 control-label">เบอร์โทร </h5>
                                <div class="col-sm-4">
                                    <input type="number" name="m_tel" class="form-control"  placeholder="เบอร์โทร">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <textarea name="m_add" class="form-control"  placeholder="ที่อยู่"></textarea>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <button type="submit" class="btn btn-danger " formaction="member.php">ยกเลิก</button>
                                </div>
