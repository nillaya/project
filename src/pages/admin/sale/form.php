                    ...
                    <div class="panel-body">
                        <form action="insert.php" class="form-horizontal" role="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="date" name="sale_date" class="form-control"  placeholder="วันที่">
                                </div>
                            </div>
                            <div class="form-group">
                                <h5 class="col-sm-2 control-label">ราคารวม</h5>
                                <div class="col-sm-6">
                                    <input type="text" name="sale_total" class="form-control"  placeholder="ราคารวม">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <button type="submit" class="btn btn-danger " formaction="sale.php">ยกเลิก</button>
                                </div>
