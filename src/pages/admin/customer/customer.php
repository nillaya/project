                            ...
                            while($row = $result->fetch_assoc()) {
                               echo "<tr>";
                                //echo "<td>" . $row["em_id"]. "</td>";
                                    ...
                                    // echo "<td>
                                    // &nbsp;&nbsp;<a href='update_form_c.php?ID=$row[cus_id]'>
                                    //     <i class='glyphicon glyphicon-pencil'></i> </a> </td>";
                                    // echo "<td>    
                                    //     <a href='delete_cus.php?ID=" . $row['cus_id']. "'
                                    //     onclick=\"return confirm('ต้องการจะลบข้อมูลนี้ใช่หรือไม่?')\">
                                    //     <i class='glyphicon glyphicon-trash'></i> </td>";
                                    echo "<td>
                                    <a href='update_form_c.php?ID=$row[cus_id]'><button class='buttons buttons2'><i class='glyphicon glyphicon-pencil'></i> </button>
